...
options("palette" = c("#ffffff", "#d1d6dc", "#da00d1", "#a700a0", "#74006f", "#f5ff02", "#dee800", "#08ff8f", "#00f485", "#00b965", "#35f8fe", "#00d8d8", "#008b8b", "#053efa", "#0434d4", "#021860", "#7a8998", "#56636f", "#2e363e", "#181C20"))
