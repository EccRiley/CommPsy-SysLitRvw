...
> _\large{"... despite our awareness of context for those we study, we do not always apply that understanding to ourselves".}_
>
...
`r tufte::newthought("\\Large{Ecological systems theory and the Social Ecological Model}")`
...
`r tufte::newthought("\\Large{Protective (versus risk) Factors}")`
...
`r tufte::newthought("\\Large{\"The inextricable relationship of _empowerment_ and politics\"}")` [@riger1993what, p. 283, _emph. added._]
