...
scat.bn %>% kable(caption = "Binomial Test of the Difference in Search Category Proportions", col.names = c("Alternative", "Null Value ($\\pi_{0}$)", "Parameter", "Estimate", "$\\chisq$", "$p$-value", "CI"), format = 'latex', booktabs = T, escape = FALSE)
...
#' -----
#'
#' `r tufte::newthought("Experimental Research Designs")`
#'
#+ exp
...
#'
#'
#' `r tufte::newthought("Qua<strong>L</strong>itative Research _Designs_")`
#'
#+ qlDesigns
...
dimnames(ftm.dql) <- list("QuaLitative Design" = levels(ct.dql$clab),
                          Category = c("IPV Interventions",
                                       "SMW-Inclusive Research"))
# t.dql
...
#' -----
#'
#' `r tufte::newthought("Qua<strong>L</strong>itative _Methods_")`
#'
#+ qlMethods
## qual methods ================
...
dimnames(ftm.ql) <- list("QuaLitative Method(s)" = levels(ct.ql$clab),
                         Category = c("IPV Interventions", "SMW-Inclusive Research"))
...
#' -----
#'
#' `r tufte::newthought("Qua<strong>L</strong>itative Data Analytic Approaches")`
#'
...
ftm.aqlp %>% kable(align = rep("r", 3),
                    caption = "Qua**L**itative Analytic Approaches")
...
#' -----
#'
#' `r tufte::newthought("Qua<strong>NT</strong>itative Research _Designs_")`
#'
#+ qtDesigns
...
dimnames(ftm.dqt) <- list("QuaNTitative Design" = levels(ct.dqt$clab),
                          Category = c("IPV Interventions",
                                       "SMW-Inclusive Research"))
# t.dqt
...
#' -----
#'
#' `r tufte::newthought("Qua<strong>NT</strong>itative _Methods_")`
#'
#+ qtMethods
### quant methods ================
...
#' -----
#'
#' `r tufte::newthought("Qua<strong>NT</strong>itative Data Analytic Approaches")`
#'
#+ qtAnalytics
## quant analytics ================
...
#' -----
#'
#' `r tufte::newthought("Mixed-Methodological _Designs_")`
#'
#+ mmDesigns
...
#' -----
#'
#' `r tufte::newthought("Mixed (Qua<strong>L</strong>itative \\& Qua<strong>NT</strong>itative) _Methods_")`
#'
#+ mmMethods
...
#+ arc_lvls, fig.height=3.75, fig.fullwidth=TRUE, out.width="1002px", out.height="550px"
