...
\KeywordTok{names}\NormalTok{(MAP)[}\DecValTok{2}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{write.csv}\NormalTok{(cpv.s3[}\KeywordTok{order}\NormalTok{(cpv.s3$year), }\KeywordTok{c}\NormalTok{(}\StringTok{"bibkey"}\NormalTok{, }\StringTok{"year"}\NormalTok{, }\StringTok{"title"}\NormalTok{, }
    \StringTok{"journal"}\NormalTok{, }\StringTok{"abstract"}\NormalTok{)], }\StringTok{"data/MAP-abstracts-S3.csv"}\NormalTok{, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{)}
\NormalTok{cpv.s4 <-}\StringTok{ }\NormalTok{MAP[MAP$scat ==}\StringTok{ "S4"}\NormalTok{, ]}
\KeywordTok{write.csv}\NormalTok{(cpv.s4[}\KeywordTok{order}\NormalTok{(cpv.s4$year), }\KeywordTok{c}\NormalTok{(}\StringTok{"bibkey"}\NormalTok{, }\StringTok{"year"}\NormalTok{, }\StringTok{"title"}\NormalTok{, }
    \StringTok{"journal"}\NormalTok{, }\StringTok{"abstract"}\NormalTok{)], }\StringTok{"data/MAP-abstracts-S4.csv"}\NormalTok{, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{)}
