...
ktopscat <- ifelse(ktopscat == "S4", paste0("@", rownames(ktop), " &lowast;"), paste0("@", rownames(ktop)))
...
kdesscat <- ifelse(kdesscat == "S4", paste0("@", rownames(kdes), " &lowast;"), paste0("@", rownames(kdes)))
...
kexpscat <- ifelse(kexpscat == "S4", paste0("@", rownames(kexp), " &lowast;"), paste0("@", rownames(kexp)))
...
kmoscat <- ifelse(kmoscat == "S4", paste0("@", rownames(kmo), " &lowast;"), paste0("@", rownames(kmo)))
...
kdqlscat <- ifelse(kdqlscat == "S4", paste0("@", rownames(kdql), " &lowast;"), paste0("@", rownames(kdql)))
...
kmqlscat <- ifelse(kmqlscat == "S4", paste0("@", rownames(kmql), " &lowast;"), paste0("@", rownames(kmql)))
...
kaqlscat <- ifelse(kaqlscat == "S4", paste0("@", rownames(kaql), " &lowast;"), paste0("@", rownames(kaql)))
...
kdqtscat <- ifelse(kdqtscat == "S4", paste0("@", rownames(kdqt), " &lowast;"), paste0("@", rownames(kdqt)))
...
kmqtscat <- ifelse(kmqtscat == "S4", paste0("@", rownames(kmqt), " &lowast;"), paste0("@", rownames(kmqt)))
...
kaqtscat <- ifelse(kaqtscat == "S4", paste0("@", rownames(kaqt), " &lowast;"), paste0("@", rownames(kaqt)))
...
krcrdscat <- ifelse(krcrdscat == "S4", paste0("@", rownames(krcrd), " &lowast;"), paste0("@", rownames(krcrd)))
...
kdmmscat <- ifelse(kdmmscat == "S4", paste0("@", rownames(kdmm), " &lowast;"), paste0("@", rownames(kdmm)))
...
kmmmscat <- ifelse(kmmmscat == "S4", paste0("@", rownames(kmmm), " &lowast;"), paste0("@", rownames(kmmm)))
...
kpopscat <- ifelse(kpopscat == "S4", paste0("@", rownames(kpop), " &lowast;"), paste0("@", rownames(kpop)))
...
kssetscat <- ifelse(kssetscat == "S4", paste0("@", rownames(ksset), " &lowast;"), paste0("@", rownames(ksset)))
...
ksmthdscat <- ifelse(ksmthdscat == "S4", paste0("@", rownames(ksmthd), " &lowast;"), paste0("@", rownames(ksmthd)))
...
kecoscat <- ifelse(kecoscat == "S4", paste0("@", rownames(keco), " &lowast;"), paste0("@", rownames(keco)))
