...
Rtdf(MAP$journal, names = c("Publication Title", "$N_{Articles}$")) %>%
    pander(caption = "Publication Titles of Reviewed Articles {#tbl:mapJrnl}")
...
pander(jsft, caption = "Number of Articles per Publication Title in Each Research Category {#tbl:jsft}")
...
Detailed source code for this process is publicly available in a GitHub repository owned and maintained by the author, which can be found at the following web address: \url{https://github.com/EccRiley/comps-git}.
