...
> **RQ-4:** What are the characteristics or patterns of the extant community-psychology-related IPV interventions body of research that either facilitate or hinder such research within contexts that are specifically inclusive of, relevant to, and appropriate for addressing same-gender IPV among sexual minority women?

> > **RQ-4a:** Which community psychological values, theories, and research methodologies facilitate or promote IPV interventions research that is inclusive of, relevant to, and appropriate for sexual minority women?

> > > **RQ-4.a.i:** To what extent have these facilitating values, theories, and research methodologies been applied in community-based or action-oriented research efforts specific or related to IPV interventions?

> > > **RQ-4.a.ii:** Within the community-psychology-related IPV interventions body of research, what gaps exist in the application of these facilitating values, theories, and methodologies?

> > **RQ-4.b:** What are the particular characteristics of community-based and action-oriented research that may in fact constitute barriers to conducting IPV interventions research that is inclusive of, relevant to, and appropriate for sexual minority women?

> > > **RQ-4.b.i:** Are such barriers a function of either or both the specific community psychological values, theories, and methods themselves or the implementation of those values, theories, and methods in community-based and action-oriented research?

> > > **RQ-4bii:** How does the extant body of IPV interventions research conducted within community-based and action-oriented research frameworks and settings inform potential solutions to such barriers?
...
$^a$ For each database search, multiple search terms were included for the subject/keywords parameters to represent intimate partner violence
...
```{r bibkeys, echo=FALSE, results='hide', message=FALSE, warning=FALSE, cache=FALSE, fig.show='none', fig.keep='none'}
source("bibkeys.R")
```
...
![](graphics/inputs/sem.png){#fig:sem}


_Figure 1. Social-Ecological Model_



![](graphics/inputs/yrhist.png){#fig:yrhist}


_Figure 2. Timeline of publication years of the reviewed literature_


![](graphics/inputs/flowchart.png){#fig:flowchart}


_Figure 3. Systematic Literature Search and Inclusion Flow-Chart_


![](graphics/inputs/topics.png){#fig:topics}


_Figure 4. Substantive Research Topics Covered across the Reviewed Empirical Research_


![](graphics/inputs/populations.png){#fig:populations}


_Figure 5. Target Populations _Included_ in the Sampling Frames among the Review Literature in Each Substantive Research Category_


![](graphics/inputs/sampling.png){#fig:sampling}


_Figure 6. Sampling Methods Employed among the Review Literature in Each Substantive Research Category_


![](graphics/inputs/aql.png){#fig:aql}


_Figure 7. Qualitative Data Analytic Approaches Implemented among the Review Literature in Each Substantive Research Category_


![](graphics/inputs/aql.png){#fig:aql}


_Figure 8. Qualitative Data Analytic Approaches Implemented among the Review Literature in Each Substantive Research Category_


![](graphics/inputs/aqt.png){#fig:aqt}


_Figure 9. Quantitative Data Analytic Approaches Implemented among the Review Literature in Each Substantive Research Category_


![](graphics/inputs/keysnet.png){#fig:keysnet}


_Figure 10. Network graph of the levels of analysis involved in the reviewed literature_


![](graphics/inputs/arc_analyses.png){#fig:arc_analyses}


_`r alnetg_cap`_

![](graphics/inputs/sysnet.png){#fig:sysnet}


_Figure 11. Network Visualization Of The Ecological Systems Involved Across The Reviewed Literature_
