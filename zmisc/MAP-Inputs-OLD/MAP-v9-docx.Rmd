...
<!-- TODO: ADD MORE DETAIL ON ANALYTIC PROCEDURES AND INITIAL IMPRESSION OF THE LIT IN EACH CATEGORY -->
...
# Conclusion: A Proposal for General Selection Criteria and Procedures for Community-Psychology-Focused Systematic Literature Reviews
...
```{r bibkeys, opts.label='invisible'}
source("bibkeys.R")
```
...
![Timeline of publication years of the reviewed literature](graphics/inputs/yrhist.png){#fig:yrhist}
...
![Network graph of the levels of analysis involved in the reviewed literature](graphics/inputs/keysnet.png){#fig:keysnet}
